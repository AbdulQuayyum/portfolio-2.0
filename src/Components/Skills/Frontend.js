...
const Frontend = () => {
    return (
        <div className='skills-content dark:bg-transparent dark:border-[#fff] dark:border-[1px]'>
            ...
            <div className="skills-box">
                ...
                <div className="skills-group">
                    ...
                    <div className="skills-data">
                        <SiAngularjs className='skills-icon' />
                        <div>
        ...
        //                     return (
        //                         <div key={item.id = index} className="skills-data">
        //                             {/* <SiHtml5 className='skills-icon' /> */}
        //                             {item.skills}
        //                             <div>
        //                                 <h3 className="skills-name dark:text-[#fff]">{item.name}</h3>
        //                                 <div className="progress-parent">
        //                                     <div id={item.name} data-tooltip-content={item.level} className={`progress-bar-${item.level}`}></div>
        //                                     <span className="skills-level dark:text-[#fff]">{item.level}</span>
        //                                 </div>
        //                             </div>
        //                         </div>
        //                     )
