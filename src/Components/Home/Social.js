...
const Social = () => {
    return (
        <div className="home-social">
            ...
            <a href="https://twitter.com/_AbdulQuayyum" target="_blank" rel="noreferrer"  className="home-social-icon dark:hover:text-gray-800 dark:text-gray-200">
                <BsTwitter />
            </a>
            ...
            <a href="https://www.instagram.com/_abdulquayyum/" target="_blank" rel="noreferrer"  className="home-social-icon dark:hover:text-gray-800 dark:text-gray-200">
                <BsInstagram />
            </a>
        </div>
    )
