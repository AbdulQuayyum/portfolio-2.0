      ...
      <motion.div
        ...
        <div className="about-data">
          ...
          <p className="about-description dark:text-[#fff]">
            I am a Software Engineer with an artistic touch, using technologies to provide innovative and efficient solutions to problems and providing more efficient solutions to available solutions.
          </p>
